...
From there, all of the scraped data was compiled into a database to then reference in visualizations to compare brands, meals, and nutritional information in a truly transparent environment. Plus users can visualize which brands use the most buzzwords, which hold true to their claims, and make their own choices about which meals suit their needs.
